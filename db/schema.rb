...
ActiveRecord::Schema.define(version: 20191209193918) do
  ...
  create_table "pets_applications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["applications_id"], name: "index_pets_applications_on_applications_id"
    t.index ["pets_id"], name: "index_pets_applications_on_pets_id"
  end
  ...
  add_foreign_key "pets_applications", "applications", column: "applications_id"
  add_foreign_key "pets_applications", "pets", column: "pets_id"
